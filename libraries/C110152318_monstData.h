...
MonstData ranInfo[] = {  // todo
    ...
    MonstData("兵馬俑", 8458, 6, 120, 1302, 10, 67, 0, 0.8),
    MonstData("木樁", 999999999, 30, 1, 1, 20, 1000000000, -1, -1),
    MonstData("莽原射手", 32349, 10, 783, 4823, 10, 223, 13, 0.3),
    MonstData("千年妖精", 100000, 80, 400, 3479, 15, 1000, 16, 0.3),
    MonstData("龍【魔王】", 73842983, 30, 1599, 12045, -1, 12487, -1, -1),
    MonstData("機器人【魔王幹部】", 3842983, 30, 1670, 5523, -1, 6543, 15, 0.3),
    MonstData("陵寢巫師", 603845, 10, 1299, 8598, -1, 3433, 14, 0.3)
};
